...
class MoxRequest(Request):
    ...
    def has_administrate_permission(self):
        ...
        return self.jwt_claims and 'administrator' in self.jwt_claims.get("roles")

    def has_manage_permission(self, assemblyIdentifier):
        # Administrator Manager
        return self.jwt_claims and 'manager@%s' % assemblyIdentifier in self.jwt_claims.get("roles")
