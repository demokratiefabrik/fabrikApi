...
__all__ = ['DBContentTree',
           # 'DBContentTreeProgression',
           #    'get_contenttree_progression_of_current_user'
           ]

# TODO: using joinedload for joins which are always used toegether.


# def get_contenttree_progression_of_current_user(request, auto_create=True):
#     """ Loads contenttree-specific user-data.
#     Method requires an authenticated user and loaded request.contenttree.
#     """
#     assert request.local_userid and request.contenttree

#     # Get AssemblyProgression
#     contenttree_progression = get_or_create_progression(
#         request,
#         DBContentTreeProgression,
#         auto_create=auto_create,
#         event_when_creating_entry=EventFirstContentTreeVisit,
#         user_id=request.local_userid,
#         contenttree=request.contenttree)

#     return(contenttree_progression)
