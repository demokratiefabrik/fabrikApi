...
class DBContent(BaseDefaultObject, ContentPluginInterface, Base):
    ...
    # content
    title = Column(UnicodeText(300), nullable=False)
    ...
    def __init__(self, title, type_, contenttree_id, user_id, text=None, parent_id=None, locked=False):
    ...
    def set_reviewed(self):
        ...
        # TODO: reload only for moderators...
        self.date_modified = arrow.now()
