...
class DBContentPeerReview(Base):
    ...
    def __init__(self, user_created_id, content, operation, data_to_apply_on_success):
        ...
        quorum, rate = self.get_approving_conditions()
    ...
    def get_approving_conditions(self):
        """ What is peerreview criteria are to apply for this specific operation.
        TODO: This method should be the default values.and should be "overwrittenable" by methods
        within the plugins.
        ...
        assert self.content.COMMON_PROPERTY_CONTENT

        quorum = get_docker_secret('fabrikapi_peerreview_respondend_quorum', default='50')  # e.g.  at least 50% approvals
        rate = get_docker_secret('fabrikapi_peerreview_approval_rate', default='5')  # e.g. at least 3 respondents
