...
class Compass:
    ...
    def __init__(self, data=None, config={}):
        ...
        self.config = {
            ...
            "minOuterY": 20,
            # to adapt the final chart
            "zoomUnits": {"top": 1.4, "bottom": -0.45, "left":0, "right": 1}            
    ...
    def assignValueToAFreeSlot(self, angle, value, skipBelowY=0):
        ...
        # for i in range(3):
        self.outerY += 1
        self.generateRowSlots(self.outerY)
    ...
    def plot(self):
        ...
        # self.config['markerSizeFactor'] = zoomFactor
    ...
    def _matplotlibMarkerSize(self, ax):
        ...
        zoomFactor = self.config["zoomUnits"]["top"] - self.config["zoomUnits"]["bottom"]
        return self.config['markerSizeFactor'] * area *         zoomFactor
