...
from fabrikApi import main, models
# from .context import fabrikApi.models
# from .context import fabrikApi.models.meta.Base
...
def dbengine(app_settings, ini_file):
    ...
    # do not drop: this easees debugging
    # Base.metadata.drop_all(bind=engine)
    # alembic.command.stamp(alembic_cfg, None, purge=True)
...
def dummy_request(app, tm, dbsession):
    ...
    # @pytest.fixture(scope="session")
    # def run_at_the_beginnning(test, request):
    #     # setup_data(request)
    #     pass
